...
process GENERATE_MEDICC_INPUT {
    ...
    script:
    """
    create_medicc_input.py medicc_input.tsv --hmmcopy_reads ${hmmcopy_results_csv.join(' --hmmcopy_reads ')} --annotation_metrics ${annotation_metrics_csv.join(' --annotation_metrics ')}
    """
}
